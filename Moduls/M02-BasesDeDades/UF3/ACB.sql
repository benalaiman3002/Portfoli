...
CREATE TABLE equip
	...
	data_creacio	DATE,
	pressupost	INT,
	estadi		VARCHAR(40)	NOT NULL,
	filial_de	VARCHAR(20)	REFERENCES equip,
	FOREIGN KEY (estadi) REFERENCES estadi(nom)
	)ENGINE = InnoDB
	;

CREATE TABLE posicio
	(nom_posicio	VARCHAR(7)		PRIMARY KEY
	)ENGINE = InnoDB
	;
...
CREATE TABLE partit
	(jornada		INT(2),
	equip_local		CHAR(20),
	equip_visitant		VARCHAR(20)	NOT NULL,
	hora			TIME,
	punts_local		INT(3),
...
CREATE TABLE arbitra
	...
	equip_local	VARCHAR(20)	REFERENCES partit,
	arbitre		VARCHAR(20)	REFERENCES arbitre,
